    ...
    public static void init() {
        ...
        EMPTY_CROWN = register("empty_crown", p -> new Item(
            p.humanoidArmor(ArmorMaterials.GOLD, ArmorType.HELMET)
             .component(DataComponents.UNBREAKABLE, Unit.INSTANCE)
             .component(DataComponents.EQUIPPABLE, crownEquipment("empty_crown"))
             .rarity(Rarity.RARE)
        ));
        ...
        CROWN = register("emperor_crown", p -> new Item(
            p.humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.HELMET)
             .fireResistant()
             .component(DataComponents.UNBREAKABLE, Unit.INSTANCE)
             .component(DataComponents.EQUIPPABLE, crownEquipment("emperor_crown"))
        ));
    }

    private static Equippable crownEquipment(String asset) {
        return Equippable.builder(EquipmentSlot.HEAD)
            .setAsset(ResourceKey.create(EquipmentAssets.ROOT_ID, NineCrowns.id(asset)))
            .build();
    }
